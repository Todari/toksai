const FAQS = [
  {
    q: "어떤 대화 파일을 올려야 하나요?",
    a: `카카오톡 채팅방에서 "대화 내보내기"로 저장한 텍스트(.txt), PC의 CSV 파일이나 그 파일을 담은 zip이면 돼요. 1:1 대화는 그대로, 단체방은 궁금한 두 사람을 골라 관계 집중 분석을 할 수 있어요.`,
  },
  {
    q: "안전한가요?",
    a: "원본 대화는 암호화해 보관하고 분석을 위해 Google Gemini로 전송해요. 메일 방식은 수신 과정에서 Resend도 거칩니다. 분석을 만든 브라우저에서는 원본과 결과를 언제든 함께 삭제할 수 있어요.",
  },
  {
    q: "메일로도 보낼 수 있나요?",
    a: "네. 시작하기에서 메일 방식을 고르면 이번 분석에만 쓰는 전용 주소가 생겨요. 카카오톡 대화 내보내기 메일을 그 주소로 보내면 화면이 수신을 확인해 자동으로 다음 단계로 이동해요.",
  },
  {
    q: "무료인가요?",
  ...
  {
    q: "안드로이드나 PC에서도 되나요?",
    a: "네. 아이폰·안드로이드의 대화 텍스트와 PC 카카오톡의 텍스트·CSV 내보내기 형식을 지원해요.",
  },
  {
    q: "분석에는 얼마나 걸리나요?",
